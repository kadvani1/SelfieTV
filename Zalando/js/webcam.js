...
function detect(imageDataBlob) {
    return $.ajax({
            ...
            beforeSend: function (xhrObj) {
                ...
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", choose(["84633bf2c350462ca105e4435aa317ae", "2e87d66f93c241dd8ec805d09c38f92b", "f7b776d5d3a84e3a9f48f3ff12d067af"]));
            },
            type: "POST",
            // Request body
            data: imageDataBlob,
...
function emotion(imageDataBlob) {
    return $.ajax({
            ...
            beforeSend: function (xhrObj) {
                // Request headers
                xhrObj.setRequestHeader("Content-Type", 'application/octet-stream');
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", choose(["e1276d5f08ae438ca10b0a7c19ef4e8c", "c14f3203d1904ec298aca7c44efd89dd", "3debebcc0f37452aa435e081683b4faa"]));
            },
            type: "POST",
            // Request body
